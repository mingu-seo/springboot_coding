...
public class JWTUtil {
    private String secretKey = "zerock12345678zerock12345678zerock12345678";
...
//                .setExpiration(Date.from(ZonedDateTime.now().plusSeconds(1).toInstant()))
    ...
    public String validateAndExtract(String tokenStr) throws Exception {
        ...
        try {
            DefaultJws defaultJws = (DefaultJws) Jwts.parser().setSigningKey(secretKey.getBytes("UTF-8")).build().parseClaimsJws(tokenStr);
            log.info(defaultJws);
